...
- method `installDependence()` to `AbstractPlugin` class

### Changed

- parameters of 'subcribe' and 'unsubcribe' methods
- some little GraphsAbstractClasses code improvements
- JSDoc of `AbstractPlugin.getPlugin()` method
